/* ------------------------------------------------------------------------
 * Created by: Krishna, Parau, Sonu, Sarita, Sujita and Baibhav
...
//---------------------------------------------------------------------------------------------------------
// Our Google Script Deployment ID:
const char *GScriptId = "AKfycbzFrCz3FeZkxVRskK-vOoOFwp-m0nrdYhbusCVZkvU0dF0gowVJtVXdp0NGjTgmOAmj";
String gate_number = "Gate1";
//---------------------------------------------------------------------------------------------------------
// Enter network credentials:
const char* ssid     = "Galaxy A50";
const char* password = "bgtv9987";
//---------------------------------------------------------------------------------------------------------
...
//------------------------------------------------------------
#define RST_PIN  27  //D27 pin of ESP32
#define SS_PIN   5  //D5 pin of ESP32
#define BUZZER   2  //D2 pin of ESP32 for Led and Buzzer
//------------------------------------------------------------
...
void loop() {
  ...
  if(client->POST(url, host, payload)){ 
    ...
    lcd.setCursor(0,1); //col=0 row=0
    digitalWrite(BUZZER, HIGH); //LED glow if ok
    lcd.print("Thanks");
    delay(1000);
  }
  //----------------------------------------------------------------
  ...
  digitalWrite(BUZZER, LOW);  //LED get Off
  delay(5000);
}
